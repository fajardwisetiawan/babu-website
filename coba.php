                ...
                <div class="mt-30 mb-30 p-30 bg-white box-shadow">
                    ...
                    <div class="most-viewed-videos mb-40">
                        ...
                        <div class="row justify-content-center p-3">
                            ...
                            <div class="col-lg-6 p-2" style="box-sizing:border-box;">
...
<?php include 'components/footer.php' ?>
  style="border-style: solid; border-width: 1px; border-color: #3282b8; margin-right: 15px; margin-left: 15px; margin-top: 3px; margin-bottom: 3px; height:400px; width: 31%;"
