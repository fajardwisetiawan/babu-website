...
<script type="text/javascript">
    ...
    async function asdqwe() {
        ...
        success: function(response) {
            ...
            $('#looping_input2').append(' <a href="timeline-twitter" style="margin-right: 20px;"><span class="btn '+ color[colori] +'" style="margin-right: 5px; padding: 5px; border-radius:50%;"></span>'+response[i].id_user+'</a> ')
            if (i == 0) {
    ...
    <section class="mag-posts-area d-flex flex-container">
        ...
        <div class="mt-30 mb-30 p-30 bg-white box-shadow" style="flex-grow: 9">
            ...
            <div class="most-viewed-videos mb-40">
                ...
                <div id="chart3"></div>
                <div class="row d-flex justify-content-center" id="looping_input2">
